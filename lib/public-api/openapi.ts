// OpenAPI 3.1.2 "source of truth" for GenialCRM Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'GenialCRM Public API',
      version: 'v1',
      description:
        'API pública do GenialCRM para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
